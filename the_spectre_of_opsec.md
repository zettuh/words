...
### what_does_this_mean?:
  ...
  *Examples include, but aren't limited to*:
  ...
  - personally identifiable information (PII) eg:
    - SSN
    - physical traits
...
- "Am I Being Detained?"
    ...
    - if no:
      - continue saying nothing and leave

## **on_direct_action**:
   *(If you are a person or allied with persons that are willing to go a step further beyond just waving a placard and shouting into a megaphone, there are some things to consider)*

**Build a threat matrix/threat model.**
    
You need to know what needs defending and from whom. 
    
That will help you organize your thinking on how to respond to various scenarios.
...
- Only bring in people you can *directly* vouch for and trust. 
      *(THIS IS EXTREMELY IMPORTANT # See the sections on Comms, Logistics, and Breadcrumbs)*
...
**SAY NOTHING** 
- **Literally don't say anything beyond invoking your right to silence and an attorney.**
- You _can_ lie to state and local cops, legally. (verify this in your state, natch)
- You _cannot_ lie to federal law enforcement, **_that's a federal crime._**  
- **DON'T TALK TO COPS.**
- The cops are better trained at interrogating than you are at being interrogated.  
...
Pay special attention to reports of misogyny, racism and sexual assault (verbal or otherwise).  A pattern of that behavior can indicate an insider trying to sow mistrust.  However, even if they aren't a plant, that kind of behavior will have a corrosive effect whose ends will be the same. 

Root out those kinds of folks once there's a pattern of that behavior.

_**"Once is an accident, twice is coincidence, three times is enemy action."**_
...
If you need to communicate with your comrades outside line of sight, there are options that leave fewer traces.
...
_If you want to be extra cautious, a spare shirt and some accessories can be worth keeping with you when you make your exit in order to not be immediately identifiable as a protestor._
_you can even thrift a pair of shoes from a thrift store if you are extra paranoid, just make sure it is something you can run in)_
...
- If attending a protest/rally/demonstration, write the phone number of someone you trust on your person in permenant ink, like a sharpie. 
    - Your forearm is a great place to do this, as it will be minimally impacted by sweat/handling things throughout the day.
...
- Once you have a location, get a feel for what the area is like, you can use Google maps for this, street view is especially handy.
    - During this time make note of any potential exits you can take.
      - _**(this depends on your threat model, if you do use google maps, don't be logged in, use a VPN, and search incognito, going even further, use a virtual machine when conducting your research)**_

    - How you get to the site is really up to you, but there is some general advice worth considering.
      - Try and park at least a few blocks away picking an area nearby that has public interests (restaurants / bars / shops) can be useful should you need to account for your whereabouts 
      - Ensure that wherever you park ingress/egress is easy
    ...
    - If you used public transportation/bike/skateboard/any combination of those, plan your routes ahead of time.
      - This option also is worth considerong when ones considers **_the now-widespread existence of automated systems to identify and track license plates_**
...
- Try and avoid being caught on CCTV cameras. 
  - Or maybe if you feel this is something you are willing to risk, blocking/jamming camera feeds is handy
...
Since your phone is tied to your information via a cell plan, that data can easily be used to identify you. 

The really cool and fun part is your phone's bluetooth is generally *still enabled* even when in airplane mode, and your phone *will* still ping cell towers. 

The easiest way to mitigate these risks is to **not take your phone with you and leave it at home**

### a quick blurb on the topic of burner phones

There is an impulse (a good one, to be clear) to acquire and use a burner phone for the purposes of organizing and discussing topics of a sensitive nature that you would want to protect from prying eyes. This is good impulse, we want to keep our active and personal lives separate. **Having said that, here is things to consider when purchasing a burner phone**

- **DO NOT** purchase the burner phone with your credit card or any form of digital payment 
  - **USE CASH**
- **DO NOT** purchase the burner phone at your local electronics store 
  - Purchase it from a store that you do not frequent, preferably in a different city 
- **DO** wear a mask, hat, and large sunglasses when purchasing your burner phone in order to protect your privacy
  - if your face / identifiable markings are visible on cctv footage where you bought the phone then you can be positively linked to said burner phone.
- **DO NOT TAKE THE PHONE HOME AND ACTIVATE IT THERE**
  - I cannot stress this enough, do not activate your **burner phone** at home
...
## **general_safety**:
  - use common sense.
  - don't start unnecessary shit with cops if it brings additional risk to yourself / others, read the crowd / match the energy, if the vibe is nonviolent, maintain course 
  - help those that need it, and overall always consider your personal safety, you are of no good to anyone if you get seriously injured/arrested 
